...
public abstract class GUIView3Bloq extends GUIView implements ActionListener, ListSelectionListener {
	...
	protected abstract Params getDetailData();
	 ...
	 */
	protected abstract Params getQueryData();
	 ...
	 * @param pResult
	 */
	protected abstract void showDelete(Params pResult);
	 ...
	 * @param pResult
	 */
	protected abstract void showInsert(Params pResult);
	 ...
	 * @param pResult
	 */
	protected abstract void showQuery(Params pResult);
	 ...
	 * @param pResult
	 */
	protected abstract void showUpdate(Params pResult);
